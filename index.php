...
function custom_js_register()
{
    ...
    wp_enqueue_script('auto-font', plugins_url('/js/min.js', __FILE__));
    wp_localize_script('auto-font', 'autoFont', array( 'plugin_url' => plugins_url() )); 
}
...
add_action('widgets_init', function () {
    return register_widget("auto_font_widget");
});
